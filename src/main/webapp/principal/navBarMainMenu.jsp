    ...
    <!--<c:set scope="session" var="isAdmin" value='<%=request.getSession().getAttribute("isAdmin") %>' ></c:set>-->
                              ...
                              <div class="">
                                  ...
                                  <c:if test="${fotoUser == '' || fotoUser ==null }">
                                      ...
                                      <div class="user-details">
                                          ...
                                          <span id="more-details"><%=request.getSession().getAttribute("login") %><i class="fa fa-caret-down"></i></span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="main-menu-content">
                                      <ul>
                                          <li class="more-details">
                                              ...
                                              <a href="ServletLogin?logout=true"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                    ...
                    -->
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                  ...
                                  <li>
                                      <a href="<%=request.getContextPath() %>/principal/grafico.jsp" class="waves-effect waves-dark">
                                          <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                          <span class="pcoded-mtext" data-i18n="nav.form-components.main">Graphics</span>
                                          <span class="pcoded-mcaret"></span>
                                      </a>
                                  </li>
            ...
            <!--  
                              ...
                              <ul class="pcoded-item pcoded-left-item">
                                  ...
                                  <li class="pcoded-hasmenu">
                                      ...
                                      <ul class="pcoded-submenu">
                                          <li class=" ">
                                              <a href="ServletLogin?logout=true" class="waves-effect waves-dark">
                                                  <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
